 ...
 * @author GNyabuto
 */
public class save_project extends HttpServlet {
HttpSession session;
String project,counties,project_id;
String message;
int code;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          dbConn conn = new dbConn();
            ...
            String checker = "SELECT id FROM project WHERE name=?";
            ...
            if(conn.rs.next()){
                ...
                String inserter = "INSERT INTO project (name) VALUES(?)";
                ...
                if(num>0){
                  ...
                  String  getmaxcounty = "SELECT MAX(id) FROM project";
                  conn.rs1 = conn.st1.executeQuery(getmaxcounty);
                  if(conn.rs1.next()){
                   project_id = conn.rs1.getString(1);
    ...
    try {
        ...
        Logger.getLogger(save_project.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
