 ...
 * @author GNyabuto
 */
public class visit_sess extends HttpServlet {
HttpSession session;
String project_id,partner_id,obligation_id;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           obligation_id = request.getParameter("obligation");
           
           session.setAttribute("project_id", project_id);
           session.setAttribute("partner_id", partner_id);
           session.setAttribute("obligation_id", obligation_id);
